...
mixin _$BaseModalState {
  ...
  /// Create a copy of BaseModalState
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $BaseModalStateCopyWith<BaseModalState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BaseModalStateCopyWith<$Res> {
  factory $BaseModalStateCopyWith(
          BaseModalState value, $Res Function(BaseModalState) then) =
      _$BaseModalStateCopyWithImpl<$Res, BaseModalState>;
  @useResult
  $Res call({BooleanStatus modalStatus});
}

/// @nodoc
class _$BaseModalStateCopyWithImpl<$Res, $Val extends BaseModalState>
    implements $BaseModalStateCopyWith<$Res> {
  _$BaseModalStateCopyWithImpl(this._value, this._then);
...
class __$$InitialImplCopyWithImpl<$Res>
    extends _$BaseModalStateCopyWithImpl<$Res, _$InitialImpl>
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl({this.modalStatus = BooleanStatus.active});
  ...
  @override
  String toString() {
    return 'BaseModalState.initial(modalStatus: $modalStatus)';
  }
...
abstract class _Initial implements BaseModalState {
