...
import 'get_collections_by_month_controller.dart';
import 'get_collections_by_month_cubit.dart';

import '/app/core/widgets/base_stateless_widget.dart';

class GetCollectionsByMonth
    extends BaseStatelessWidget<GetCollectionsByMonthController,
        GetCollectionsByMonthCubit,
        GetCollectionsByMonthState> {
  int month;
  int year;
  GetCollectionsByMonth({Key? key, super.controller, super.onStateChanged, required this.month, required this.year})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<GetCollectionsByMonthCubit>(
      create: (context) => createCubitAndAssignToController(context),
      child: BlocConsumer<GetCollectionsByMonthCubit,
          GetCollectionsByMonthState>(
        ...
        builder: (context, state) {
          ...
          final data = state.getCollectionsByMonthResponse;
          ...
          return state.getCollectionsByMonthResponse != null
              ? Container(
            child: Column(
              children: [
                Container(
              ...
              : state.getCollectionsByMonthStatus == BooleanStatus.error
              ? Center(
            child: Text("No records found for selected month"),
          )
  ...
  @override
  GetCollectionsByMonthCubit createCubitAndAssignToController(
      BuildContext context) {
    GetCollectionsByMonthCubit cubit = GetCollectionsByMonthCubit(
        context: context, month: month, year: year);
