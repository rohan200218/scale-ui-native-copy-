...
import 'get_collections_by_date_controller.dart';
import 'get_collections_by_date_cubit.dart';
import '/app/core/widgets/base_stateless_widget.dart';

class GetCollectionsByDate
    extends BaseStatelessWidget<GetCollectionsByDateController,
        GetCollectionsByDateCubit,
        GetCollectionsByDateState> {
  String? date;
  GetCollectionsByDate({Key? key, super.controller, super.onStateChanged, this.date})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocProvider<GetCollectionsByDateCubit>(
      create: (context) => createCubitAndAssignToController(context),
      child: BlocConsumer<GetCollectionsByDateCubit, GetCollectionsByDateState>(
        ...
        builder: (context, state) {
          ...
          final data = state.getCollectionsByDateResponse;
          ...
          return Container(
            child: state.getCollectionsByDateResponse != null
                ? Container(
              child: Column(
                children: [
                  Container(
                ...
                : state.getCollectionsByDateStatus == BooleanStatus.error
                ? Center(
              child: Text("No records found for selected date"),
            )
  ...
  @override
  GetCollectionsByDateCubit createCubitAndAssignToController(
      BuildContext context) {
    GetCollectionsByDateCubit cubit = GetCollectionsByDateCubit(
